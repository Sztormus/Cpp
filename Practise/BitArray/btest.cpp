 ...
 * Tablica ta musi byc alokowana dynamicznie.
 *
...
int main() {
  ...
  std::cout << "ba:"  << std::endl; // oczywiscie const
  ba.print();
  std::cout  << std::endl;
  ...
  cb.print();
  std::cout << "\ncb " << cb[3] << cb[2] << cb[1] << cb[0] << std::endl;
...
large: 
00000 <-120 00000000 <-112 00000000 <-104 00000000 <-96 00000000 <-88 00000000 <-80 00000000 <-72 00000001 <-64 00000000 <-56 00000000 <-48 00000000 <-40 00000000 <-32 00000000 <-24 00000000 <-16 00110000 <-8 00000000 <-0 1111 <-0 
cb 1111
 */
